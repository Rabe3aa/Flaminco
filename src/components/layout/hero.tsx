        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 max-w-2xl relative z-20">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-neutral">
                Data-Driven
              </span><br/> Marketing.
            </motion.h1>
            ...
            >
              We craft modern digital experiences, driving ROI through high-performance SEO, targeted campaigns, and elite creative design.
            </motion.p>
            ...
            >
              ...
              >
                <span className="mr-4">Start Your Campaign</span>
              ...
              >
                <span className="mr-4">View Our Work</span>
            ...
            >
              <div className="p-8 md:p-10 rounded-[2.5rem] shadow-[0_20px_40px_rgba(0,0,0,0.08)] border border-white/40 bg-white/70 backdrop-blur-xl relative overflow-hidden">
                ...
                <div className="flex items-end gap-3 mb-6 relative z-10">
                  <span className="text-6xl md:text-7xl font-black text-brand-primary tracking-tighter leading-none">9.6</span>
                ...
                <div className="flex items-center gap-4 relative z-10 pt-5 border-t border-brand-neutral/10">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-bold text-brand-primary">150+ Clients</span>
