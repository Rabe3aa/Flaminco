...
export function AnimatedBackground() {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none bg-brand-bg">
      ...
      {/* Elegant Wavy Lines SVG. The waves drift via cheap GPU-composited CSS
          transforms (transform only) — no per-frame JS path redrawing. */}
